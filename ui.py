...
class MobileApp(QMainWindow):
    ...
    def __init__(self):
        ...
        self.start_label.setText("Submit image")
        self.start_label.move(5, 5)
        self.mid_label = QLabel(self)
        self.mid_label.setText("of a potential")
        self.mid_label.move(105, 5)
        self.last_label = QLabel(self)
        self.last_label.setText("missing perso")
        self.last_label.move(203, 5)
        self.last_label = QLabel(self)
        self.last_label.setText("n:")
        self.last_label.move(303, 5)
    ...
    def get_mobile_num(self):
        ...
        self.mobile_label.move(150, 120)

        self.mobile = QLineEdit(self)
        self.mobile.move(150, 150)
    ...
    def get_location(self):
        ...
        self.location_label.move(150, 190)

        self.location = QLineEdit(self)
        self.location.move(150, 220)
